...
// Attempt to locate a repository with a copy of a particular object.
...
main(int argc, char* argv[])
{
  ...
  try {
    ...
    // Find a copy of this object
    VestaSource *vs = ReposUI::filenameToRealVS(cpath, hints);

    // Display the authoritative address for the repository the
    // copy was found in
